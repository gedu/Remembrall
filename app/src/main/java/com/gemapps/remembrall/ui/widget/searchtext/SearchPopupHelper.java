...
public class SearchPopupHelper implements SearchTextWatcher.SearchWatcherListener,
  ...
  WeakReference<TextInputEditText> mTextWeakReference;
  SearchTextWatcher mSearchTextWatcher;
  ...
  private void displayProductPopupMenu() {
    ...
    popupMenu.setOnDismissListener(new PopupMenu.OnDismissListener() {
      ...
      public void onDismiss(PopupMenu menu) {
        mTextWeakReference.get().removeTextChangedListener(mSearchTextWatcher);
      }
    });
    popupMenu.show();
  }
